...
class DBManager:
    ...
    def __init__(self, params):
        self.conn = psycopg2.connect(dbname='hhdatabase', **params)
...
vacancy_with_keybord = db_manager.get_vacancies_with_keyword(conn=psycopg2.connect(dbname='hhdatabase', **params), keyword='Флорист')
